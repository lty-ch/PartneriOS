//
//  ExtensionAddAgent+MediaFile.swift
//  LTY_Partner
//
//  Created by CTS on 31/05/23.
//

import Foundation
import UIKit

extension AddNewAgentVC : UINavigationControllerDelegate, UIDocumentMenuDelegate, UIDocumentPickerDelegate, UIImagePickerControllerDelegate {
