//
//  AddNewCust+ExtensionUItextfield.swift
//  LTY_Partner
//
...
extension AddNewCustomerVC : UITextFieldDelegate,UINavigationControllerDelegate, UIDocumentMenuDelegate, UIDocumentPickerDelegate, UIImagePickerControllerDelegate  {
...
//        }))
    ...
    func documentPicker(_ controller: UIDocumentPickerViewController, didPickDocumentsAt urls: [URL]) {
        ...
        do {
            ...
            if Double(imageSize) / 1000000.0 < 25.0 {
                ...
                self.requestNativeImageUpload(tf: self.btnTag == 501 ? self.textShowFrontDoc : self.textShowBackDoc, docName: filename)
            }
        } catch {
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [UIImagePickerController.InfoKey : Any]) {
        ...
        self.requestNativeImageUpload(tf: self.btnTag == 501 ? self.textShowFrontDoc : self.textShowBackDoc, docName: pickedImageUrl?.lastPathComponent ?? "")
    }
