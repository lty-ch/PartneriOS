...
class LeadProposalSendCell: UITableViewCell {

    
    @IBOutlet weak var heightSendBtn: NSLayoutConstraint!
...
//        self.delegate?.setEditAction(data: sender.tag)
    }
