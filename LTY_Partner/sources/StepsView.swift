...
open class StepView: UIView {
    ...
    @IBInspectable public var circleBorderColor: UIColor = UIColor(red: 0/255, green: 147/255, blue: 80/255, alpha: 1)
    @IBInspectable public var circleFilledColor: UIColor  = UIColor(red: 0/255, green: 147/255, blue: 80/255, alpha: 1)
    @IBInspectable public var circleRadius: CGFloat = 15
    @IBInspectable public var circleBorderWidth: CGFloat = 2
    
    @IBInspectable public var selectedCircleBorderColor: UIColor = UIColor(red: 0/255, green: 147/255, blue: 80, alpha: 1)
    @IBInspectable public var selectedCircleFilledColor: UIColor = .clear
    @IBInspectable public var selectedCircleRadius: CGFloat = 40
    
    @IBInspectable public var lineBorderColor: UIColor?
    @IBInspectable public var lineBorderHeight: CGFloat = 2
